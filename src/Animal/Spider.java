...
public class Spider extends Animal {
    public static String animalName = "Spider";
    public String currentWord = "";
    
// registering the class to AnimalFactory
    static {
        AnimalFactory.getInstance().registerAnimal(Spider.class);
    }
    ...
    public void draw(int position) {
        currentWord = "";
        setSpeed(0);
        ImageIcon icon = new ImageIcon("image/spider.gif");
        ...
        atas += position * label.getWidth()/2 + position*15 + 15 ;
