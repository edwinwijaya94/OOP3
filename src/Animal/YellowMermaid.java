 ...
 * @author elvan_owen
 */
public class YellowMermaid extends Animal {
    public static String animalName = "YellowMermaid";
    public String currentWord = "";
    
// registering the class to AnimalFactory
    static {
        AnimalFactory.getInstance().registerAnimal(YellowMermaid.class);
    }
    ...
    public void draw(int position) {
        currentWord = "";
        setSpeed(5);
        ImageIcon icon = new ImageIcon("image/mermaid2.gif");
        Image image = icon.getImage();
        label = new JLabel();
        label.setText("");
        label.setIcon(icon);
        label.setSize(490,160);
