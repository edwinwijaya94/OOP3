 ...
 * @author elvan_owen
 */
public class CrazyWolf extends Animal {
    public static String animalName = "CrazyWolf";
    public String currentWord = "";
    
    // registering the class to AnimalFactory
    static {
        AnimalFactory.getInstance().registerAnimal(CrazyWolf.class);
    }
