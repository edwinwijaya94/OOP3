...
public class Mosquito extends Animal {
    public static String animalName = "Mosquito";
    public String currentWord = "";
    
// registering the class to AnimalFactory
    static {
        AnimalFactory.getInstance().registerAnimal(Mosquito.class);
    }
    ...
    public void draw(int position) {
        currentWord = "";
        setSpeed(5);
        ImageIcon icon = new ImageIcon("image/mosquito.gif");
    ...
    public void playSound(){
        ...
        String path = "music/mosquito.wav";
        try{
