...
public class Gorilla extends Animal {
    public static String animalName = "Gorilla";
    public String currentWord = "";
    
// registering the class to AnimalFactory
    static {
        AnimalFactory.getInstance().registerAnimal(Gorilla.class);
    }
    ...
    public void draw(int position) {
        currentWord = "";
        setSpeed(20);
        ImageIcon icon = new ImageIcon("image/gorilla.gif");
